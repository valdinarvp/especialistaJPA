...
insert into cliente (id, nome) values(1,"Vinícius Pereira");
insert into cliente (id, nome) values(2, "Vitória Karina");
insert into cliente (id, nome) values(3, "Karla Pereira");